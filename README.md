...
![Lab machines overview](screenshots/image1.png)
...
![Ubuntu SIEM Adapter 1 settings](screenshots/image2.png)
![Ubuntu SIEM Adapter 2 settings](screenshots/image3.png)
  ...
  ethernets:
    ...
    enp0s8:
      addresses:
        - 192.168.100.20/24
```
![Ubuntu SIEM netplan config](screenshots/image4.png)
...
![Kali Adapter 1 settings](screenshots/image5.png)
![Kali Adapter 2 settings](screenshots/image6.png)
...
```
![Kali interfaces file](screenshots/image7.png)
...
ping 192.168.100.20
```
![Kali ip addr / ping result](screenshots/image8.png)
![Kali ping result continued](screenshots/image9.png)

Also ping back from the Ubuntu SIEM machine to confirm bidirectional connectivity — this worked correctly.

![Ping from Ubuntu SIEM dashboard back to Kali](screenshots/image10.png)
  ...
  ethernets:
    enp0s3:
      addresses:
        - 192.168.100.30/24
```
![Ubuntu Victim netplan file](screenshots/image11.png)
![Ubuntu Victim netplan file continued](screenshots/image12.png)
...
```
![Netcat port checks against the SIEM](screenshots/image13.png)
...
![Ping victim <-> attacker](screenshots/image14.png)
![Ping victim <-> attacker continued](screenshots/image15.png)
![Ping victim <-> Ubuntu SIEM dashboard](screenshots/image16.png)
![Ping victim <-> Ubuntu SIEM dashboard continued](screenshots/image17.png)
...
ping 192.168.100.20
```
![Windows Victim TCP/IPv4 settings](screenshots/image18.png)
![Windows Victim adapter properties](screenshots/image19.png)

Pinging the Ubuntu SIEM from Windows worked.

![Ping from Windows to Ubuntu SIEM](screenshots/image20.png)
![Ping from Windows to Ubuntu SIEM (2)](screenshots/image21.png)
...
![Disabling the Windows Firewall](screenshots/image22.png)
![Ping now working after firewall disabled](screenshots/image23.png)

Ping between the Ubuntu victim and the Windows victim was also confirmed working.

![Ping victim1 (Ubuntu) <-> victim2 (Windows)](screenshots/image24.png)
...
![Final connectivity test — all three targets reachable](screenshots/image25.png)
...
```
![apt update / upgrade](screenshots/image26.png)

Wazuh ships an official all-in-one install script:

![Wazuh install script](screenshots/image27.png)

```bash
curl -sO https://packages.wazuh.com/4.9/wazuh-install.sh
curl -sO https://packages.wazuh.com/4.9/config.yml
```
![Downloading install script and config](screenshots/image28.png)
...
nodes:
  ...
  dashboard:
    - name: dashboard
      ip: 192.168.100.20
```
![Edited config.yml](screenshots/image29.png)

Run the installer:
```bash
sudo bash wazuh-install.sh --generate-config -i
```
![Running the installer](screenshots/image30.png)
![Cleanup and install output](screenshots/image31.png)
...
```
![Re-downloading install files](screenshots/image32.png)
![Re-checking config.yml](screenshots/image33.png)
![Re-checking config.yml continued](screenshots/image34.png)
![Reinstall output](screenshots/image35.png)
![Disk resized to 51200 MB](screenshots/image36.png)
...
```
![Install running again after resize](screenshots/image37.png)
![Successful install output](screenshots/image38.png)
...
![Wazuh dashboard login screen](screenshots/image39.png)
...
df -h
```
![Service status check](screenshots/image40.png)
![Service status check continued](screenshots/image41.png)
![Service status check continued](screenshots/image42.png)
![Service status check continued](screenshots/image43.png)
![Service status check continued](screenshots/image44.png)
...
![Netstat showing Wazuh ports open](screenshots/image45.png)
...
![Kali agent install](screenshots/image46.png)
![Kali agent status](screenshots/image47.png)
![Kali agent status continued](screenshots/image48.png)
...
curl -o wazuh-agent.deb https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_4.9.2-1_amd64.deb
```
![Downloading agent package on SIEM](screenshots/image49.png)

2. Transfer it to the Ubuntu Victim and confirm it arrived:
```bash
ls -la wazuh-agent.deb
```
![Confirming the package arrived on the victim](screenshots/image50.png)
...
sudo systemctl start wazuh-agent
```
![Installing the agent on Ubuntu Victim](screenshots/image51.png)

4. Verify it's running:
```bash
sudo systemctl status wazuh-agent --no-pager
```
![Ubuntu Victim agent status](screenshots/image52.png)

5. Confirm enrollment/connection:
```bash
sudo grep "wazuh-agentd" /var/ossec/logs/ossec.log | tail -20
```
![Ossec log grep — enrollment](screenshots/image53.png)
![Ossec log grep — enrollment continued](screenshots/image54.png)

6. Back on the Ubuntu SIEM, confirm the agent shows up:
```bash
sudo /var/ossec/bin/agent_control -l
```
![agent_control -l showing Ubuntu Victim](screenshots/image55.png)
...
```
![Downloading the Windows MSI on the SIEM](screenshots/image56.png)

2. Still on the Ubuntu SIEM, serve it over the internal lab network with a temporary web server:
```bash
python3 -m http.server 8000
```
![Serving the MSI with a Python HTTP server](screenshots/image57.png)
...
![Downloading the MSI in the Windows browser](screenshots/image58.png)
...
dir
```
![PowerShell — Downloads folder](screenshots/image59.png)
![PowerShell — Downloads folder listing](screenshots/image60.png)
...
![msiexec install command and output](screenshots/image61.png)
...
NET START WazuhSvc
```
![NET START WazuhSvc](screenshots/image62.png)

```powershell
Get-Service -Name WazuhSvc
```
![Get-Service confirming Running](screenshots/image63.png)
...
```
![Windows agent ossec.log tail](screenshots/image64.png)
...
sudo /var/ossec/bin/agent_control -l
```
![agent_control -l — all agents listed](screenshots/image65.png)
...
![Dashboard — win-victim activity](screenshots/image66.png)
![Dashboard — win-victim activity continued](screenshots/image67.png)
![Dashboard — win-victim activity continued](screenshots/image68.png)
![Dashboard — win-victim activity continued](screenshots/image69.png)
...
![Agent status dots on the dashboard](screenshots/image70.png)
![Agents overview dashboard](screenshots/image71.png)
![Agents overview dashboard continued](screenshots/image72.png)

All three agent types were successfully deployed; FIM was verified enabled on the Windows victim.

![FIM enabled confirmation on win-victim](screenshots/image73.png)
![FIM detail view](screenshots/image74.png)
![FIM detail view continued](screenshots/image75.png)
...
![Enabling File Integrity Monitoring](screenshots/image76.png)

On Ubuntu:

![Ubuntu endpoint FIM configuration](screenshots/image77.png)
![Ubuntu endpoint FIM configuration continued](screenshots/image78.png)
![Ubuntu endpoint FIM alert log](screenshots/image79.png)
![Ubuntu endpoint FIM alert log continued](screenshots/image80.png)
![Ubuntu endpoint FIM dashboard](screenshots/image81.png)
![Ubuntu endpoint FIM dashboard continued](screenshots/image82.png)
![Ubuntu endpoint FIM dashboard continued](screenshots/image83.png)
...
```
![Editing ossec.conf via Notepad](screenshots/image84.png)
![ossec.conf edits](screenshots/image85.png)
![ossec.conf edits continued](screenshots/image86.png)
![ossec.conf edits continued](screenshots/image87.png)
![FIM test file created](screenshots/image88.png)
![FIM alert generated](screenshots/image89.png)
![FIM alert detail](screenshots/image90.png)
...
![Vulnerability detection configuration](screenshots/image91.png)
![Vulnerability detection dashboard](screenshots/image92.png)
![Vulnerability detection dashboard continued](screenshots/image93.png)
...
![VirusTotal API key](screenshots/image94.png)

```xml
<!-- inside <ossec_config> -->
```
![VirusTotal integration block](screenshots/image95.png)

Save the file and restart the manager:
```bash
sudo systemctl restart wazuh-manager
```
![Restarting the manager](screenshots/image96.png)
![VirusTotal test result](screenshots/image97.png)
![VirusTotal test result continued](screenshots/image98.png)
![VirusTotal test result continued](screenshots/image99.png)
![VirusTotal test result continued](screenshots/image100.png)
![VirusTotal test result continued](screenshots/image101.png)
![VirusTotal test result continued](screenshots/image102.png)
![VirusTotal test result continued](screenshots/image103.png)
![VirusTotal test result continued](screenshots/image104.png)
![VirusTotal test result continued](screenshots/image105.png)
![VirusTotal test result continued](screenshots/image106.png)

### Auditd — Monitoring Malicious Command Execution (Linux)

![Monitoring malicious command execution overview](screenshots/image107.png)

Install and configure `auditd` on the Ubuntu agent:

![Installing auditd](screenshots/image108.png)
![Auditd configuration](screenshots/image109.png)

Create a CDB list of suspicious programs:
```bash
sudo nano /var/ossec/etc/lists/suspicious-programs
```
![Suspicious programs CDB list](screenshots/image110.png)

Then locate the `<ruleset>` section in `/var/ossec/etc/ossec.conf` and wire it in:

![Ruleset configuration](screenshots/image111.png)
![Ruleset configuration continued](screenshots/image112.png)

Restart the manager:
```bash
sudo systemctl restart wazuh-manager
```
![Restarting wazuh-manager](screenshots/image113.png)

### Process Monitoring — Unauthorized Process Detection (Linux)

Enabled Wazuh's process-list monitoring:

![Process monitoring configuration](screenshots/image114.png)

Then restarted the agent and manager:
```bash
sudo systemctl restart wazuh-agent
```
![Restarting wazuh-agent](screenshots/image115.png)
![Process monitoring test / alerts](screenshots/image116.png)

```bash
sudo systemctl restart wazuh-manager
```
![Restarting wazuh-manager](screenshots/image117.png)
...
![DNS troubleshooting](screenshots/image118.png)
![DNS troubleshooting continued](screenshots/image119.png)
![DNS troubleshooting continued](screenshots/image120.png)
![DNS troubleshooting continued](screenshots/image121.png)
![DNS troubleshooting continued](screenshots/image122.png)
...
```
![Sysmon download](screenshots/image123.png)
![Sysmon config for Wazuh (GitHub)](screenshots/image124.png)
...
![ossec.conf — Sysmon localfile block](screenshots/image125.png)
![Sysmon integration in place](screenshots/image126.png)
![Sysmon integration in place continued](screenshots/image127.png)

Restart the manager:
```bash
sudo systemctl restart wazuh-manager
```
![Restarting the manager](screenshots/image128.png)
![Sysmon events flowing into Wazuh](screenshots/image129.png)
...
![Suricata install](screenshots/image130.png)
![suricata.yaml HOME_NET config](screenshots/image131.png)
![suricata.yaml config continued](screenshots/image132.png)
![Suricata rules file path](screenshots/image133.png)
![Suricata setup continued](screenshots/image134.png)
...
![Custom Suricata rules](screenshots/image135.png)
![Suricata rules loaded](screenshots/image136.png)
...
```
![Restarting Suricata](screenshots/image137.png)
![Suricata alerts firing](screenshots/image138.png)
![Suricata test result](screenshots/image139.png)
